...
def test_to_client_image_url_with_relative_path(monkeypatch):
...
def test_to_client_image_url_with_s3_public_base(monkeypatch):
    monkeypatch.setenv("S3_PUBLIC_BASE_URL", "https://assets.example.com/public")

    assert to_client_image_url("hot_places/seongsu.png") == "https://assets.example.com/public/hot_places/seongsu.png"
    assert to_client_image_url("/hot_places/seongsu.png") == "https://assets.example.com/public/hot_places/seongsu.png"
