...
class CategoryType(str, Enum):
    ...
    def description(cls) -> str:
        ...
        hints = {
            "관광지": "관광명소, 유적지, 테마파크, 해수욕장, 섬, 자연경관, 궁, 박물관, 미술관, 전시관",
            "콘텐츠": "팝업스토어, 브랜드 팝업, 축제, 공연, 콘서트, 전시회, 페스티벌, 문화행사, 체험",
            "숙박":   "호텔, 펜션, 게스트하우스, 리조트, 모텔, 에어비앤비",
            "음식점": "음식점, 카페, 식당, 레스토랑, 맛집, 한식, 양식, 일식, 분식, 치킨, 피자",
            "투어":   "투어, 여행 코스, 가이드 투어, 당일치기 여행, 체험 프로그램, 스포츠, 레포츠, 액티비티",
        }
