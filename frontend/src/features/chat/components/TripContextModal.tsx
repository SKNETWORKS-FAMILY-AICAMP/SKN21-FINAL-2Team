            ...
            {isOpen && (
                <>
                    ...
                    <div className="hidden md:flex fixed inset-0 z-[9999] items-center justify-center p-4 pointer-events-none">
                        ...
                        >
                            <div className="bg-white rounded-3xl shadow-2xl w-full p-7 relative">
                            {loading && (
                    ...
                    >
                        <div className="min-h-full p-6 pb-8">
                            ...
                            <button
                                onClick={handleClose}
                                className="mb-6 p-2 text-gray-400 hover:text-gray-700 hover:bg-gray-100 rounded-full transition-colors"
                            >
                                <X size={20} />
                            </button>
                            ...
                            <button
                                onClick={handleTravelerConfirm}
                                disabled={!canProceed}
                                className={`mt-6 w-full py-3 rounded-2xl text-sm font-medium flex items-center justify-center gap-2 transition-all duration-200 ${canProceed
                                    ? "bg-black text-white hover:bg-gray-800 active:scale-[0.98]"
                                    : "bg-gray-100 text-gray-300 cursor-not-allowed"
                                    }`}
                            >
                            ...
                            <button
                                ...
                                className="mt-4 w-full flex items-center justify-center gap-1 text-xs font-medium text-gray-500 hover:text-gray-500 transition-colors"
                            >
                                건너뛰고 바로 시작하기
                                <ArrowRight size={12} />
                            </button>
