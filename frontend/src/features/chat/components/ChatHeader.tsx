...
export function ChatHeader({
    ...
    return (
        <header className="h-14 flex items-center justify-between pl-16 pr-3 sm:px-4 lg:px-6 bg-white z-10 sticky top-0 border-b border-gray-100 rounded-t-[inherit]">
